...
fitted_vals=regr.predict(features) #get the fitted(predicted) values
...
def get_dollar_estimate(rm,ptratio,chas=False,large_range=True):
    ...
    ptratio -- number of students per teacher in the school in the area.
    ...
    print(f'USD {round_low} at the lower end to USD {round_hi} at the high end.')  